					...
					<div class="row">
						<div class="col">
							<div class="top_bar_content d-flex flex-row align-items-center justify-content-start">
								...
								<div class="top_bar_item"><a href="contanct.php">Jln.Titus Nau, RT 002 RW 001, Fatukoa, Kota Kupang</a></div>
								<!-- <div class="top_bar_item"><a href="#">Jln.Budi Kemasyarakatan No. 5 Pulo Brayan Kota, Medan</a></div> -->
								<!-- <div class="emergencies  d-flex flex-row align-items-center justify-content-start ml-auto">NO : +62852-7794-8885</div>  -->
							</div>
						</div>
					</div>
				</div>
							...
							<div class="header_content d-flex flex-row align-items-center justify-content-start">
								<nav class="main_nav ml-auto">
									<ul>
										...
										<li><a href="news_gereja.php">BERITA</a></li>
								...
								<a href="index.php">
									<div class="logo_content d-flex flex-column align-items-start justify-content-center">
										...
										<div class="logo d-flex flex-row align-items-center justify-content-center">
											<div class="logo_text">LUZ<span> FATUKOA</span></div>
											<!-- <div class="logo_box">+</div> -->
										</div>
										<!-- <div class="logo_sub">Jl. Titus Nau</div> -->
									</div>
								</a>
							</div>
						</div>
			...
			<div class="menu_inner menu_mm">
				<div class="menu menu_mm">
					<ul class="menu_list menu_mm">
						...
						<hr class="my-2">
						<p class="menu_item menu_mm fa fa-photo"><a href="laporan.php"> LAPORAN</a></p>
						<hr class="my-2">
						<p class="menu_item menu_mm fa fa-book"><a href="news_gereja.php"> BERITA</a></p>
						<hr class="my-1">
						<p class="menu_item menu_mm fa fa-map-marker"><a href="admin/index.php"> LOGIN</a></p>
						<hr class="my-1">

					</ul>
				</div>
				<div class="menu_extra">
					<div class="menu_appointment"><a href="#">Gereja LUZ Fatukoa</a></div>
					<!-- <div class="menu_emergencies">HUB : 0000 - 0000 - 0000</div> -->
				</div>
