...
<div class="card-body">
    ...
    <div class="table-responsive">
        ...
        <table class="table">
            ...
            $sql = mysqli_query($konek, "SELECT * FROM tbl_mjh LIMIT " . $limit_start . "," . $limit);
            ...
            ?>
                <tr>
                    ...
                    <td><a href="#" onclick="showImage('../img/mjh/<?php echo htmlspecialchars($data['foto']); ?>')">LIHAT FOTO</a></td>
                    <td> <a href="mjh_edit.php?id=<?php echo base64_encode($data['kode']); ?>">EDIT</a></td>
                    <td> <a href="mjh_hapus.php?id=<?php echo $data['kode']; ?> ">DELETE</a></td>
                </tr>
            <?php
...
<ul class="pagination">
    ...
    ?>
        <li><a href="mjh_tampil.php?page=1">SEBELUM</a></li>
        <li><a href="mjh_tampil.php?page=<?php echo $link_prev; ?>">&laquo;</a></li>
    <?php
    }
    ?>
    ...
    $sql2 = mysqli_query($konek, "SELECT COUNT(*) AS jumlah FROM tbl_mjh");
    ...
    ?>
        <li<?php echo $link_active; ?>><a href="mjh_tampil.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
        <?php
    }
        ?>
        ...
        ?>
            <li><a href="mjh_tampil.php?page=<?php echo $link_next; ?>">&raquo;</a></li>
            <li><a href="mjh_tampil.php?page=<?php echo $jumlah_page; ?>">SELANJUTNYA</a></li>
        <?php
        }
        ?>
</ul>
