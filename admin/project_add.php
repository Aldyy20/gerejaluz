    ...
    <div class="row d-flex">
      <div class="col-lg-12">
        ...
        <div class="form-group row has-success">
          ...
          <div class="col-sm-10">
            <input type="text" name="txtkategori" class="form-control is-valid" placeholder="Jenis Kegiatan">
          </div>
        </div>
        <div class="form-group row has-success">
          <label class="col-sm-2 form-control-label">DESKRIPSI</label>
          <div class="col-sm-10">
            <input type="text" name="txtjudul" class="form-control is-valid" placeholder="Deskripsi">
          </div>
        </div>
        <div class="form-group row has-success">
        ...
        <div class="form-group row has-success">
          ...
          <div class="col-sm-10">
            <input type="text" name="txtstatus" hidden="" class="form-control is-valid" placeholder="Status Kegiatan">
          </div>
        </div>
        <!--   <div class="form-group row has-success">
